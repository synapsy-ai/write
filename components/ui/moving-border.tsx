...
export function BorderAnimation({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative flex h-full w-full items-center justify-center border bg-white/[0.8] text-sm text-white antialiased backdrop-blur-xl dark:border-slate-800 dark:bg-slate-900/[0.8]",
          className,
        )}
        style={{
