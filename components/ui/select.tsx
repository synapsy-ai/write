...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "hover:bg-accent/50 focus:bg-accent/60 focus:text-accent-foreground relative flex w-full cursor-default items-center rounded-sm border border-transparent py-1.5 pr-2 pl-8 text-sm outline-hidden select-none hover:border-slate-300 data-disabled:pointer-events-none data-disabled:opacity-50 dark:hover:border-slate-700",
      className,
    )}
    {...props}
  >
