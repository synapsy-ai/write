...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm border border-transparent py-1.5 pl-8 pr-2 text-sm outline-hidden hover:border-slate-300 hover:bg-accent/50 focus:bg-accent/60 focus:text-accent-foreground data-disabled:pointer-events-none data-disabled:opacity-50 dark:hover:border-slate-700",
      className,
    )}
    {...props}
  >
